🌐 [English](../README.md) | [Portugues](README_PT.md) | [Italiano](README_IT.md) | [Francais](README_FR.md) | 🇷🇺 [Русский](README_RU.md) | 🇨🇳 [中文](README_ZH.md) | [Polski](README_PL.md) | [Nederlands](README_NL.md) | [Turkce](README_TR.md) | [Deutsch](README_DE.md) | Tiếng Việt [Tiếng Việt](README_VN.md) | [Espanol](README_ES.md) | **Indonesia** | 🇸🇦 [العربية](README_AR.md)
...
<p align="center">
  ...
  <i>72 alat Full / 55 alat LITE - Satu firmware - Beberapa perangkat</i>
</p>

---

Modifikasi dari [Bruce Firmware](https://github.com/pr3y/Bruce) dengan modul **Arsenal** khusus. Semua fitur asli Bruce tetap utuh.

## Instalasi

1. Unduh `.bin` dari [Releases](../../releases)
2. Flash melalui [ESP Web Flasher](https://espressif.github.io/esptool-js/) (Chrome/Edge) atau OTA melalui Arsenal Dashboard

---

## Alat Arsenal (72 Full / 55 LITE)

| # | Alat | Full | LITE | | # | Alat | Full | LITE |
|---|------|:----:|:----:|-|---|------|:----:|:----:|
...
Arsenal > Dashboard. Hubungkan ke `ArsenalNet` (kata sandi: `arsenal32`). Buka `192.168.4.1`.

## Penghargaan

- [Bruce Firmware](https://github.com/pr3y/Bruce) oleh pr3y
